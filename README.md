...
| `deepseek-v3`                | 128K    | `Reasoning` | ~1.9s   |
...
| `magistral-medium-latest`          | 128K    | `General`   | ~1.9s   |
...
| `pixtral-12b-2409`                 | 32K     | `Vision`    | ~1.9s   |
