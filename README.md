...
| Free Model       | Star Rating | Context | Best For   | Latency | Opinion                                                  |
| :--------------- | :---------- | :------ | :--------- | :------ | :------------------------------------------------------- |
| `glm-4.5-flash`  | ★★★★☆       | 128K    | `Fallback` | ~1.7s   | Older flash, handles basic scripting with direct output. |
...
| Free Model                                      | Star Rating | Context | Best For  | Latency | Opinion                                                                   |
| :---------------------------------------------- | :---------- | :------ | :-------- | :------ | :------------------------------------------------------------------------ |
| `BruhzWater/Sapphira-L3.3-70b-0.1`              | ★★★★☆       | 128K    | `General` | ~1.3s   | Llama 3.3 70B fine-tune, good reasoning with clean instruction following. |
| `meganova-ai/manta-flash-1.0`                   | ★★★★☆       | 128K    | `General` | ~1.3s   | MegaNova's own flash, fast clean responses.                               |
| `meganova-ai/manta-mini-1.0`                    | ★★★★☆       | 128K    | `General` | ~1.3s   | Compact Manta, efficient for lightweight tasks.                           |
| `mistralai/Mistral-Small-3.2-24B-Instruct-2506` | ★★★★☆       | 32K     | `General` | ~1.6s   | Official Mistral 24B, good quality-to-speed ratio.                        |
| `Sao10K/L3-70B-Euryale-v2.1`                    | ★★★★☆       | 128K    | `General` | ~1.4s   | Community Llama 3 70B fine-tune, solid general-purpose.                   |
...
| `rnj-1:8b`             | ★★★★★       | 8K      | `General`   | ~1.9s   | Dont let the 8B fool you, fast with surprising depth.                    |
...
| `llama-3.3-70b-instruct:free`  | ★★★★☆       | 128K    | `General`  | ~1.2s   | The 70B, complex instruction following without drama.                 |
...
| `qwen/qwen3.5-397b-a17b`    | ★★★★★       | 256K    | `General`   | ~4.0s   | 397B model for that one critical prompt a week.               |
...
| `google/gemma-4-31b-it`     | ★★★★☆       | 32K     | `General`   | ~2.2s   | Google's 31B, good daily generalist for mixed chat and code.  |
