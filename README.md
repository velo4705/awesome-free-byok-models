...
Naga AI is a lightweight inference hub offering a small set of free models from NVIDIA and Meta through an OpenAI-compatible endpoint. The free tier provides 10 RPM with 100 requests per day -- a very tight cap that limits it to occasional queries and quick debugging. Naga AI currently has 1 model verified.
...
| Free Model                                | Context  | Best For     | Latency  |
| :---------------------------------------- | -------- | ------------ | -------- |
| `minimax/minimax-m2:free`                 | 200K     | `General`    | ~1.25s   |
| `minimax/minimax-m2.1:free`               | 200K     | `General`    | ~1.58s   |
| `minimax/minimax-m2.1-highspeed:free`     | 200K     | `General`    | ~1.35s   |
| `minimax/minimax-m2.5:free`               | 200K     | `General`    | ~2.07s   |
| `minimax/minimax-m2.5-highspeed:free`     | 200K     | `General`    | ~1.24s   |
| `minimax/minimax-m2.7:free`               | 200K     | `General`    | ~2.08s   |
| `minimax/minimax-m2.7-highspeed:free`     | 200K     | `General`    | ~7.95s   |
| `minimax/minimax-m3:free`                 | 1M       | `General`    | ~1.29s   |
| `mistralai/codestral-2508`                | 256K     | `Code`       | ~0.53s   |
| `mistralai/devstral-medium`               | 128K     | `Code`       | ~3.31s   |
| `mistralai/ministral-14b`                 | 128K     | `General`    | ~0.61s   |
| `mistralai/ministral-3b`                  | 128K     | `General`    | ~1.48s   |
| `mistralai/ministral-8b`                  | 128K     | `General`    | ~1.39s   |
| `mistralai/mistral-large-2512`            | 262K     | `Reasoning`  | ~3.66s   |
| `mistralai/mistral-medium-3.5`            | 32K      | `General`    | ~5.44s   |
| `mistralai/mistral-small-2603`            | 32K      | `General`    | ~2.4s    |
| `qwen/qwen-plus-2025-07-28:free`          | 128K     | `General`    | ~2.54s   |
| `qwen/qwen3-omni-flash:free`              | 128K     | `Vision`     | ~2.22s   |
| `qwen/qwen3-coder-plus:free`              | 131K     | `Code`       | ~3.21s   |
| `qwen/qwen3-vl-plus:free`                 | 128K     | `Vision`     | ~2.32s   |
| `qwen/qwen3-max:free`                     | 262K     | `General`    | ~2.47s   |
| `qwen/qwen3.5-397b-a17b:free`             | 128K     | `General`    | ~2.55s   |
| `qwen/qwen3.5-flash:free`                 | 128K     | `General`    | ~2.21s   |
| `qwen/qwen3.5-omni-flash:free`            | 128K     | `Vision`     | ~2.2s    |
| `qwen/qwen3.5-omni-plus:free`             | 128K     | `Vision`     | ~2.01s   |
| `qwen/qwen3.5-plus:free`                  | 256K     | `Reasoning`  | ~2.23s   |
| `qwen/qwen3.6-27b:free`                   | 128K     | `General`    | ~3.27s   |
| `qwen/qwen3.6-35b-a3b:free`               | 262K     | `General`    | ~2.9s    |
| `qwen/qwen3.6-max-preview:free`           | 256K     | `General`    | ~2.55s   |
| `qwen/qwen3.6-plus:free`                  | 256K     | `General`    | ~2.27s   |
| `qwen/qwen3.7-flash:free`                 | 1M       | `General`    | ~2.35s   |
| `qwen/qwen3.7-max:free`                   | 262K     | `General`    | ~3.47s   |
| `qwen/qwen3.7-plus:free`                  | 256K     | `General`    | ~2.27s   |
| `qwen/qwen3.8-max:free`                   | 262K     | `General`    | ~2.96s   |
| `qwen/qwen3.8-omni-flash:free`            | 128K     | `Vision`     | ~2.43s   |
| `sensenova/sensenova-6.7-flash-lite`      | 128K     | `General`    | ~1.19s   |
| `sensenova/sensenova-6.8-flash-lite`      | 128K     | `General`    | ~2.9s    |
...
OpenRouter is a unified API gateway providing access to hundreds of models from dozens of providers through a single endpoint. The free tier offers rate-limited access to community-hosted models (marked with `:free`) that changes often. A great backup when other providers are rate-limited. OpenRouter currently has 16 models verified.
...
| `poolside/laguna-s-2.1:free`                         | 262K    | `Code`      | ~1.3s   |
| `poolside/laguna-xs-2.1:free`                        | 128K    | `Code`      | ~1.9s   |
| `qwen/qwen3.8-27b:free`                              | 131K    | `Code`      | ~1.7s   |
