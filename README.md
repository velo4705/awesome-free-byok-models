...
| Free Model                                      | Context | Best For    | Latency |
| :---------------------------------------------- | ------- | ----------- | ------- |
| `deepseek-ai/deepseek-v4-flash`                 | 128K    | `Reasoning` | ~1.7s   |
| `google/gemma-4-31b-it`                         | 32K     | `General`   | ~2.0s   |
...
| `meta/llama-3.2-1b-instruct`                    | 128K    | `Fallback`  | ~0.5s   |
| `meta/llama-3.2-90b-vision-instruct`            | 128K    | `Vision`    | ~1.5s   |
| `mistralai/mistral-medium-3.5-128b`             | 128K    | `Reasoning` | ~0.8s   |
