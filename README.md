...
xKiro AI is an API gateway offering free models from DeepSeek, Qwen, Mistral, MiniMax and more via an OpenAI-compatible API. The free tier offers 5M TPD for free models. xKiro AI currently has 29 models verified.
...
| `poolside/laguna-s-2.1:free`                         | 262K    | `Code`      | ~1.3s   |
| `poolside/laguna-xs-2.1:free`                        | 128K    | `Code`      | ~1.9s   |
| `z-ai/glm-5.2:free`                                  | 128K    | `General`   | ~1.0s   |
