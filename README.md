...
| `doubao-1-5-lite-32k-250115:free`         | 32K     | `General`   | ~2.0s   |
...
| `gpt-5-nano-2025-08-07:free`              | 400K    | `Code`      | ~2.0s   |
...
| `nvidia/nemotron-3-ultra-550b-a55b`             | 1M      | `General`   | ~1.79s  |
...
xKiro AI is an API gateway offering free models from DeepSeek, Qwen, Mistral, MiniMax and more via an OpenAI-compatible API. The free tier offers 5M TPD for free models. xKiro AI currently has 38 models verified.
...
| `deepseek/deepseek-v4-flash`             | 1M      | `Reasoning` | ~2.22s  |
