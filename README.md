...
Void AI is an inference hub offering models from OpenAI, Google, DeepSeek, Qwen, Moonshot, Zhipu, and more through an OpenAI-compatible endpoint. The free tier provides 100 RPM with 125,000 daily credits -- Sustained for light coding. Void AI currently has 36 verified coding-relevant models.
...
xKiro AI is an API gateway offering free models from DeepSeek, Qwen, Mistral, MiniMax and more via an OpenAI-compatible API. The free tier offers 5M TPD for free models. xKiro AI currently has 34 models verified.
...
| Free Model                              | Context | Best For    | Latency   |
| :-------------------------------------- | ------- | ----------- | --------- |
| `mistralai/codestral-2508`              | 256K    | `Code`      | ~1.24s    |
| `mistralai/devstral-medium`             | 128K    | `Code`      | ~0.79s    |
| `mistralai/ministral-14b`               | 128K    | `General`   | ~3.58s    |
| `mistralai/ministral-3b`                | 128K    | `General`   | ~0.56s    |
| `mistralai/ministral-8b`                | 128K    | `General`   | ~1.92s    |
| `mistralai/mistral-large-2512`          | 262K    | `Reasoning` | ~0.63s    |
| `mistralai/mistral-medium-3.5`          | 32K     | `General`   | ~0.71s    |
| `mistralai/mistral-small-2603`          | 32K     | `General`   | ~0.59s    |
| `minimax/minimax-m2:free`               | 200K    | `General`   | ~2.34s    |
| `minimax/minimax-m2.1:free`             | 200K    | `General`   | ~1.7s     |
| `minimax/minimax-m2.1-highspeed:free`   | 200K    | `General`   | ~11.8s    |
| `minimax/minimax-m2.5-highspeed:free`   | 200K    | `General`   | ~11.93s   |
| `minimax/minimax-m2.7:free`             | 200K    | `General`   | ~2.74s    |
| `minimax/minimax-m2.7-highspeed:free`   | 200K    | `General`   | ~3.41s    |
| `qwen/qwen-plus-2025-07-28:free`        | 128K    | `General`   | ~2.58s    |
| `qwen/qwen3-omni-flash:free`            | 128K    | `Vision`    | ~2.3s     |
| `qwen/qwen3-coder-plus:free`            | 131K    | `Code`      | ~2.72s    |
| `qwen/qwen3-vl-plus:free`               | 128K    | `Vision`    | ~2.8s     |
| `qwen/qwen3-max:free`                   | 262K    | `General`   | ~2.91s    |
| `qwen/qwen3.5-397b-a17b:free`           | 128K    | `General`   | ~2.23s    |
| `qwen/qwen3.5-flash:free`               | 128K    | `General`   | ~2.42s    |
| `qwen/qwen3.5-omni-flash:free`          | 128K    | `Vision`    | ~2.56s    |
| `qwen/qwen3.5-omni-plus:free`           | 128K    | `Vision`    | ~2.14s    |
| `qwen/qwen3.5-plus:free`                | 256K    | `Reasoning` | ~2.41s    |
| `qwen/qwen3.6-27b:free`                 | 128K    | `General`   | ~2.13s    |
| `qwen/qwen3.6-35b-a3b:free`             | 262K    | `General`   | ~2.42s    |
| `qwen/qwen3.6-max-preview:free`         | 256K    | `General`   | ~3.18s    |
| `qwen/qwen3.6-plus:free`                | 256K    | `General`   | ~2.3s     |
| `qwen/qwen3.7-flash:free`               | 1M      | `General`   | ~2.47s    |
| `qwen/qwen3.7-max:free`                 | 262K    | `General`   | ~2.5s     |
| `qwen/qwen3.7-plus:free`                | 256K    | `General`   | ~2.4s     |
| `qwen/qwen3.8-max:free`                 | 262K    | `General`   | ~3.62s    |
| `qwen/qwen3.8-omni-flash:free`          | 128K    | `Vision`    | ~2.89s    |
| `sensenova/sensenova-6.7-flash-lite`    | 128K    | `General`   | ~3.66s    |
