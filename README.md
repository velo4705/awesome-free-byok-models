...
Filtered for coding and general chat capability across all 38 providers.
...
FreeInference is a research-backed inference hub providing access to models from GLM, MiniMax, Qwen, and DeepSeek through an OpenAI-compatible endpoint. The free tier offers $20 in daily credits with 2 concurrent requests. FreeInference currently has 4 models verified.
...
| `deepseek-r1-0528:free`                         | 128K    | `Reasoning` | ~2.6s   |
| `deepseek-r1:free`                              | 128K    | `Reasoning` | ~2.6s   |
| `deepseek-reasoner:free`                        | 128K    | `Reasoning` | ~2.6s   |
| `deepseek-v3-0324:free`                         | 128K    | `Reasoning` | ~2.4s   |
| `deepseek-v3.1-terminus:free`                   | 128K    | `Reasoning` | ~2.4s   |
| `deepseek-v3.1:free`                            | 128K    | `Reasoning` | ~2.4s   |
| `deepseek-v3.2:free`                            | 128K    | `Reasoning` | ~3.4s   |
| `deepseek-v3:free`                              | 128K    | `Reasoning` | ~2.4s   |
...
| `glm-5.3-flash-thinking:free`                   | 128K    | `Reasoning` | ~2.5s   |
| `glm-5.3-flash:free`                            | 128K    | `General`   | ~2.5s   |
...
| `meta/llama-3.2-1b-instruct`                    | 128K    | `General`     | ~0.8s   |
| `meta/llama-3.2-90b-vision-instruct`            | 128K    | `Vision`      | ~1.9s   |
...
| `nvidia/llama-3.1-nemotron-nano-vl-8b-v1`       | 128K    | `Vision`      | ~1.3s   |
...
| `nvidia/nemotron-3.5-lightning-30b-a3b`         | 128K    | `General`     | ~1.3s   |
| `nvidia/nemotron-mini-4b-instruct`              | 128K    | `Fallback`    | ~1.3s   |
...
OpenRouter is a unified API gateway providing access to hundreds of models from dozens of providers through a single endpoint. The free tier offers rate-limited access to community-hosted models (marked with `:free`) that changes often — no credit card required. A great backup when other providers are rate-limited. OpenRouter currently has 10 models verified.
...
| `gpt-4o:free`                             | 128K    | `General`   | ~1.6s   |
| `gpt-5-mini-2025-08-07:free`              | 128K    | `General`   | ~2.2s   |
| `gpt-5-nano-2025-08-07:free`              | 128K    | `Code`      | ~2.0s   |
| `gpt-5.1-2025-11-13:free`                 | 128K    | `General`   | ~1.6s   |
...
Void AI is an inference hub offering models from OpenAI, Google, DeepSeek, Qwen, Moonshot, Zhipu, and more through an OpenAI-compatible endpoint. The free tier provides 100 RPM with 125,000 daily credits. No credit card required. Void AI currently has 20 verified coding-relevant models.
